    ...
    public class CircularWeapon : ProjectileWeapon
    {
        public override bool Use(Vector2 holderPosition, Vector2 holderDirection)
        {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                Vector2 newPos = holderPosition + new Vector2(Mathf.Cos(angle) * _weaponStats.GetStats(WeaponStatisticEnum.Range), Mathf.Sin(angle) * _weaponStats.GetStats(WeaponStatisticEnum.Range));
